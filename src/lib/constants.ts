...
export const TESTIMONIALS = [
  ...
  },
  {
    ...
    rating: 5,
    text: 'Outstanding structural engineering services. The team provided innovative solutions that saved us time and money while ensuring complete safety compliance.',
